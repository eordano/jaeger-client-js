...
export class TChannelBridge {
  ...
  constructor(tracer: Tracer, options: any = {}) {
    ...
    this._codec = new TextMapCodec({
      ...
      baggagePrefix:
        TCHANNEL_TRACING_PREFIX + constants.TRACER_BAGGAGE_HEADER_PREFIX,
    })
  ...
  tracedHandler(handlerFunc: any, options: any = {}): Function {
    return (perProcessOptions, request, headers, body, callback) => {
      ...
      let wrappingCallback: Function = this._tchannelCallbackWrapper.bind(
        null,
        span,
        callback,
      )
  ...
  _wrapTChannelSend(
    ...
    clientSpan.setTag(
      ...
      opentracing.Tags.SPAN_KIND_RPC_CLIENT,
    )
  ...
  _wrapTChannelRequest(
    channel: any,
    wrappedRequestMethod: any,
    requestOptions: any,
  ) {
    ...
    let tchannelRequest: any = wrappedRequestMethod.call(
      channel,
      requestOptions,
    )
